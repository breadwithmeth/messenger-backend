...
Получает список чатов организации с поддержкой фильтрации, сортировки и пагинации. Чаты автоматически сортируются по приоритету, количеству непрочитанных сообщений и времени последнего сообщения.
...
| `assigned` | boolean | Нет | Фильтр по назначению оператору | `true` (назначенные), `false` (неназначенные) |
...
| `sortBy` | Описание |
|----------|----------|
| `lastMessageAt` | Сортировка по времени последнего сообщения |
| `createdAt` | Сортировка по времени создания чата |
...
### 4. Срочные чаты с непрочитанными сообщениями
...
### 7. С пагинацией (страница 2, по 20 чатов)
...
### 8. Сортировка по количеству непрочитанных (убывание)
...
### 9. Сортировка по дате создания (от старых к новым)
...
### 10. Сортировка по имени (алфавитный порядок)
...
### 11. Комбинированные фильтры с сортировкой
