...
const getChatAnalytics = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    `;
        ...
        const [chatsCreated, activeChatsRows, byStatus, byChannel, totalMessages, inboundMessages, outboundMessages, responseTimeRows, resolutionTimeRows,] = yield Promise.all([
            chatsCreatedPromise,
            activeChatsPromise,
            byStatusPromise,
            byChannelPromise,
        ...
        res.json({
            ...
            sla: {
                firstResponseSeconds: {
                    chatsWithResponse: Number((_e = responseTime.chats_with_response) !== null && _e !== void 0 ? _e : 0),
                ...
                resolutionSeconds: {
                    chatsClosed: Number((_f = resolutionTime.chats_closed) !== null && _f !== void 0 ? _f : 0),
