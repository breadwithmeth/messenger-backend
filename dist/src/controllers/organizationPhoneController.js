...
exports.createOrganizationPhone = createOrganizationPhone;
exports.listOrganizationPhones = listOrganizationPhones;
exports.connectOrganizationPhone = connectOrganizationPhone;
exports.disconnectOrganizationPhone = disconnectOrganizationPhone;
 ...
 */
function createOrganizationPhone(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const existingPhone = yield authStorage_1.prisma.organizationPhone.findUnique({
                where: {
                    phoneJid: phoneJid,
 ...
 * @param res Ответ Express.
 */
function listOrganizationPhones(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const organizationId = res.locals.organizationId;
        if (!organizationId) {
        ...
        try {
            const phones = yield authStorage_1.prisma.organizationPhone.findMany({
 ...
 * @param res Ответ Express.
 */
function connectOrganizationPhone(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const organizationId = res.locals.organizationId;
        const organizationPhoneId = parseInt(req.params.organizationPhoneId, 10);
        ...
        try {
            const phone = yield authStorage_1.prisma.organizationPhone.findUnique({
            ...
            const existingSock = (0, baileys_1.getBaileysSock)(organizationPhoneId);
            if (existingSock) {
                const currentWebSocket = existingSock.ws;
                const isOpen = currentWebSocket.readyState === ws_1.default.OPEN;
                const isConnecting = currentWebSocket.readyState === ws_1.default.CONNECTING;
            ...
            yield (0, baileys_1.startBaileys)(organizationId, organizationPhoneId, phone.phoneJid);
 ...
 * @param res Ответ Express.
 */
function disconnectOrganizationPhone(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const organizationId = res.locals.organizationId;
        const organizationPhoneId = parseInt(req.params.organizationPhoneId, 10);
        if (!organizationId || isNaN(organizationPhoneId)) {
        ...
        try {
            ...
            if (sock) {
                yield sock.logout(); // Завершаем сессию WhatsApp
...
//# sourceMappingURL=organizationPhoneController.js.map